...
-   `userMapboxToken` **([string][57] | null)** Default: `null`
-   `exportMapboxToken` **[boolean][58]** deprecated, use `userMapboxToken` instead. Default: `false`
-   `mode` **[string][57]** export html mode.
